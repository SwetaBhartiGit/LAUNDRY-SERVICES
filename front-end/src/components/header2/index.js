...
function Header(){
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a  href="/"className="dropdown-item" ><small className='explore'>Explore</small></a></li>
    <li><a  href="/"className="dropdown-item" > <small className='about'>About us</small></a></li>
    <li><a  href="/"className="dropdown-item" onClick={()=>{removeToken()}} ><small className='log'>Logout</small></a></li>
  </ul>
</div>
        </div>
