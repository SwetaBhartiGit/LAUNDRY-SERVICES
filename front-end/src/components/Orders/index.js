                        ...
                        <div className="modal-content summary-content">
                            <div className="modal-header">
                                ...
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                    ...
                                    <div className="modal-body">
                                        <div className="store">
                                            <div className='storeloc'><a href="/">Store Location</a><br />Jp Nagar</div>
                                            <div className='storeadd'><a href="/">Store Address</a><br />Near phone booth, 10th road</div>
                                            <div className='storephone'><a href="/">Phone</a><br />91 9999999999</div>
                                        </div>
